    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="bg-white border-b border-border px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {(location?.city||user.city)&&<div title={locationTracking?"Position actuelle":"Localisation du profil"} className="hidden sm:flex max-w-36 items-center gap-1.5 text-xs text-muted-foreground bg-gray-50 px-2.5 py-1 rounded-full border border-gray-200"><Navigation className={`w-3 h-3 shrink-0 ${locationTracking?"text-emerald-600":"text-gray-400"}`}/><span className="truncate">{location?.city||user.city}</span></div>}
