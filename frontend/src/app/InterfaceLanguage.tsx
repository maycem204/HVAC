...
const PHRASES: Array<[string,string]> = [
  ...
  ["La géolocalisation n’est pas disponible sur ce navigateur.","Geolocation is unavailable in this browser."],
  ["La localisation est bloquée. Autorisez-la dans les réglages du navigateur, puis réessayez.","Location access is blocked. Allow it in your browser settings, then try again."],
  ["La position est active, mais sa synchronisation a temporairement échoué.","Location is active, but synchronization temporarily failed."],
  ["La recherche GPS prend du temps. Le suivi reste actif.","GPS location is taking longer than expected. Tracking remains active."],
  ["Le navigateur empêche l’activation de la position. Vérifiez l’autorisation de localisation du site.","The browser prevented location activation. Check this site’s location permission."],
  ["Le suivi est désactivé, mais la position de votre ville n’a pas pu être actualisée.","Tracking is off, but your city location could not be updated."],
  ["Position GPS momentanément indisponible. Le suivi reste actif.","GPS location is temporarily unavailable. Tracking remains active."],
  ["Annulé","Cancelled"],["Confirmé","Confirmed"],["Terminé","Completed"],["Bloqué","Blocked"],
  ["Bloquer ce technicien","Block this technician"],["Débloquer ce technicien","Unblock this technician"],
  ["Distance indisponible","Distance unavailable"],["Écoute en cours…","Listening…"],
  ["Impossible d’annuler ce rendez-vous.","Unable to cancel this appointment."],
  ["Impossible de confirmer le rendez-vous, réessayez.","Unable to confirm the appointment. Please try again."],
  ["Impossible de consulter les agendas pour le moment. Réessayez dans quelques instants.","Unable to check schedules right now. Please try again shortly."],
  ["Désolé, le service de devis est momentanément indisponible.","Sorry, the quote service is temporarily unavailable."],
  ["Non déterminé","Not determined"],["Non déterminée","Not determined"],["Non indiqué","Not provided"],["Non indiquée","Not provided"],
  ["Oui, annuler","Yes, cancel"],["Votre expérience…","Your experience…"],
  ["Message non envoyé. Vérifiez votre connexion puis réessayez.","Message not sent. Check your connection and try again."],
  ["8 caractères minimum","8 characters minimum"],["Accès GPS refusé. Saisissez votre ville manuellement.","GPS access denied. Enter your city manually."],
  ["GPS indisponible sur ce navigateur. Saisissez votre ville manuellement.","GPS is unavailable in this browser. Enter your city manually."],
  ["GPS indisponible. Saisissez votre ville manuellement.","GPS unavailable. Enter your city manually."],
  ["La localisation a pris trop de temps. Reessayez ou saisissez votre ville.","Location timed out. Try again or enter your city."],
  ["Position GPS indisponible. Saisissez votre ville manuellement.","GPS location unavailable. Enter your city manually."],
  ["Une erreur est survenue. Vérifiez vos identifiants.","An error occurred. Check your credentials."],
  ["Ville ou localisation du local professionnel","Business city or location"],["Votre ville…","Your city…"],
  ["Élevée","High"],["Maintenance préventive","Preventive maintenance"],["Pompe à chaleur","Heat pump"],["Réfrigération","Refrigeration"],
  ["Impossible d’enregistrer le profil.","Unable to save the profile."],["Impossible de lire le fichier sélectionné.","Unable to read the selected file."],
  ["La ville ou la localisation du profil est obligatoire.","Profile city or location is required."],
  ["Votre navigateur ne permet pas de redimensionner cette image.","Your browser cannot resize this image."],
  ["À diagnostiquer","Needs diagnosis"],["Acceptés","Accepted"],["Date précise","Specific date"],
  ["Déposez ici","Drop here"],["Enregistrer les horaires","Save working hours"],
  ["Format accepté : CSV, Excel .xlsx/.xlsm ou PDF texte.","Accepted formats: CSV, Excel .xlsx/.xlsm, or text PDF."],
  ["Importez votre grille tarifaire","Import your pricing list"],["Impossible d’enregistrer les horaires.","Unable to save working hours."],
  ["Impossible de charger vos évaluations pour le moment.","Unable to load your ratings right now."],
  ["Impossible de réaffecter cette demande pour le moment.","Unable to reassign this request right now."],
  ["L’heure de fin doit être après l’heure de début.","The end time must be after the start time."],
  ["Le client n’a enregistré ni coordonnées GPS, ni adresse, ni ville.","The customer has not provided GPS coordinates, an address, or a city."],
  ["Le fichier dépasse 5 Mo.","The file exceeds 5 MB."],["Localisation non renseignée","Location not provided"],
  ["Masquer les détails","Hide details"],["Modifier les informations","Edit information"],["Non attribuée","Unassigned"],
  ["Non précisé","Not specified"],["Non précisée","Not specified"],["Non renseignée","Not provided"],["Prévu","Scheduled"],
  ["Tous les jours","Every day"],["Voir le détail des évaluations","View rating details"],["Aucun avis","No reviews"],
  ["Technicien HVAC","HVAC technician"],
];
