...
export interface Lead { id: number; client: string; problem: string; price: number; currency: string; confidence: number; time: string; status: "new" | "accepted" | "done"; city: string; faultType: string; appointmentId?: number; requestedDate?: string; requestedTime?: string; address?: string; }
