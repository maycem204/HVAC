...
export interface AppUser { id: number; name: string; email: string; phone: string; address: string; city: string; role: Role; avatar: string; lat?: number; lng?: number; live_location_active?: boolean; }
...
export interface WorkingHour { weekDay: number; enabled: boolean; startTime: string; endTime: string; }
